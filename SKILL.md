...
- If the user asks to generate a design system and does not specify a target format, produce `design-spec.html`, `DESIGN.md`, and `app-preview.html` by default and summarize the result briefly.
